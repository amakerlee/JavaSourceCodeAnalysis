...
{
    // 链表中元素的个数，transient 表示序列化时不包括该变量
     ...
     * 顺序。
     *
     * @August 注意：链表的所有操作都要考虑到，当前节点是否为空，
     *                            以及当前节点是否是头结点或者尾结点
     *
    ...
    /**
     * 将指定元素 push 到列表所代表的的栈里，即插入到列表末尾。
     *
